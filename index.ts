...
var buyItems: string[] = ["eggs", "wafers", "snacks", "chocolates", "bread", "cream", "lays"]
...
let array2: number[] = [1, 76, 54, 30, 4, 5, 54, -3, -4, -6];
...
console.log("Array after removing Odd numbers:", filtered_Numbers);
 ...
 let newarrayFruits : string [] = array.map(array => array.length ===5 ? array : "")
